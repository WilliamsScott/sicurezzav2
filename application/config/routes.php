...
$route['quitarestacionamiento'] = 'administrador/quitarestacionamiento';
$route['quitarestacionamientov'] = 'administrador/quitarestacionamientov';
...
$route['habilitardepartamento'] = 'administrador/habilitardepartamento';
$route['deshabilitardepartamento'] = 'administrador/deshabilitardepartamento';
$route['habilitare'] = 'administrador/habilitare';
$route['habilitarDepa'] = 'administrador/habilitarDepa';
$route['key'] = 'administrador/key';
...
$route['cargarRafa'] = 'administrador/cargarRafa';
$route['cargarRafa2'] = 'administrador/cargarRafa2';
$route['paginacionrafa'] = 'administrador/paginacionrafa';
...
$route['residenteyvehiculo']= 'administrador/residenteyvehiculo';
...
$route['buscarVehiculo'] = 'administrador/buscarVehiculo';
$route['buscarVehiculoPatente'] = 'administrador/buscarVehiculoPatente';
$route['buscarResidenteVehiculo'] = 'administrador/buscarResidenteVehiculo';
$route['eliminarVehiculoResidente'] = 'administrador/eliminarVehiculoResidente';
$route['vehiculoRe'] = 'administrador/vehiculoRe';
